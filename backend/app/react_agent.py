...
def get_stock_price(stock_symbol: str):
    """Call to get the current stock price and related information for a given stock symbol. This is a mocked function and only supports 'AAPL'."""
...
def get_nps_score(country_code: str):
    """Get the Net Promoter Score (NPS) for Vodafone in a given country. This is a mocked function and supports country codes 'UK', 'DE', and 'PT'."""
    # This is a mock implementation
    mock_nps_data = {
...
def get_deep_detraction_rate(country_code: str):
    """Get the Deep Detraction Rate for Vodafone in a given country, including a historical trend. This is a mocked function and supports country codes 'UK', 'DE', and 'PT'."""
    # This is a mock implementation
    mock_ddr_data = {
        "UK": {
